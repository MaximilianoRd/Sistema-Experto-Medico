...
<head>
	<title>SE Medico</title>
	<link rel="stylesheet" type="text/css" href="css/cssmax.css">
</head>
...
//----------------------------------------------
	...
	echo "<h2>Consulte a su medico</h2>";
	echo "</div>";
}
...
//SI HA ACERTADO
	...
	//-----------------------------------------------------
	echo "<div class = pregunta>";
	echo "<h2>Para confirmar su diagnostico consulte a su medico</h2>";
	echo "</div>";
}
